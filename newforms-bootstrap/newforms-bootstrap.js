/**
 * newforms-bootstrap 0.1.0 (dev build at Sun, 30 Nov 2014 12:48:51 GMT) - https://github.com/insin/newforms-bootstrap
 * MIT Licensed
 */
...
var BootstrapForm = Form.extend({
  ...
  render:function() {
    ...
    rows.push.apply(rows, this.visibleFields().map(function(field)
      {return React.createElement(BootstrapField, {key: field.htmlName, field: field, spinner: this.spinner});}.bind(this)
    ))
    ...
    if (this.nonFieldPending()) {
      rows.push(React.createElement("span", {key: this.addPrefix('__pending__'), className: "help-block"},
        React.createElement("img", {src: this.spinner}), " Validating…"
      ))
    }
    return rows
  }
