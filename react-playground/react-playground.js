/*!
 * react-playground 1.0.0 (dev build at Mon, 15 Dec 2014 11:43:21 GMT) - https://github.com/insin/react-playground
 * MIT Licensed
 */
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.Playground=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
function renderDoc(doc) {
  if (Object.prototype.hasOwnProperty.call(doc, '__html')) {
    return React.createElement("span", {dangerouslySetInnerHTML: doc})
  }
  return doc
}
...
var Playground = React.createClass({displayName: 'Playground',
  ...
  onChange:function(e) {
    ...
    this.setState({error: null, src:src}, callback)
  },
  ...
  onToggleEval:function(e) {
    this.setState({evalOnChange: e.target.checked})
  },

  evalSrc:function() {
    try {
      var $__0=  this.state,src=$__0.src
      var $__1=  this.props.previewer,context=$__1.context
  ...
  render:function() {
    var $__0=     this.state,error=$__0.error,evalOnChange=$__0.evalOnChange,input=$__0.input,src=$__0.src
    var $__1=   this.props.previewer,examples=$__1.examples,contextDoc=$__1.contextDoc
    return React.createElement("div", {className: "container"}, 
      React.createElement("div", {className: "row header"}, 
        React.createElement("div", {className: "col-md-12"}, 
          React.createElement("h1", null, React.createElement("a", {href: this.props.titleLink}, this.props.title)), 
          React.createElement("p", {className: "lead"}, this.props.leadText)
        )
      ), 
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "col-md-6"}, 
          React.createElement("h3", null, "Source"), 
          React.createElement("p", {className: "text-muted"}, "Live code editor. Changes will be reflected in the preview to the right."), 
          React.createElement("div", null, 
            React.createElement("div", {className: "form-group"}, 
             React.createElement("p", null, React.createElement("b", null, "Examples")), 
             React.createElement("select", {className: "form-control", onChange: this.onChangeExample}, 
               examples.map(function(example, index)  {return React.createElement("option", null, 
                 index + 1, ". ", example.name
               );})
              )
            ), 
            React.createElement("div", {className: "form-group"}, 
              React.createElement("p", null, React.createElement("b", null, "Context Variables")), 
              React.createElement("ul", null, 
                Object.keys(contextDoc).map(function(var_)  {return React.createElement("li", null, 
                  React.createElement("strong", null, var_), " – ", renderDoc(contextDoc[var_])
                );})
              )
            ), 
            React.createElement("div", {className: "form-group"}, 
            ...
            React.createElement("div", {className: "row"}, 
              ...
              React.createElement("div", {className: "col-sm-6"}, 
                React.createElement("div", {className: "checkbox pull-right"}, 
                  React.createElement("label", null, 
                    React.createElement("input", {type: "checkbox", checked: evalOnChange, onClick: this.onToggleEval}), ' ', 
        ...
        React.createElement("div", {className: "col-md-6"}, 
          ...
          input && React.createElement(this.props.previewer, {key: previewKey, input: input})
        )
      )
    )
  }
...
},{"codemirror/mode/javascript/javascript":3,"react-code-mirror":4}],2:[function(require,module,exports){
